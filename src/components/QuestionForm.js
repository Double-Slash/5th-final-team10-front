   ...
   function onCheckChange(checkedValues){ // 체크 박스 선택 감지
    ...
    function createDatePicker(){ 
        return (<div><Space id='startDate' direction="vertical"><DatePicker placeholder='yyyy.mm.dd' onChange={onDateChange}/></Space>
         <span style={{marginLeft:'10px', marginRight:'10px', fontWeight:'400', fontSize:'15px'}}>~</span> 
    ...
    return ( 
        <div style={{marginTop:'47px',marginBottom:'57px',marginLeft:'30px',marginRight:'30px',fontFamily:'Noto Sans CJK KR'}}>

            <div style={{width:'1000px'}}>
                <div style={{position:'absolute',fontWeight:'400',fontSize:'13px',marginRight:'30px'}}>질문 {props.question.questionNo}
                </div>
                <div style={{marginLeft:'100px'}}>
                    <span style={{fontWeight:'700'}}>{props.question.question}</span>
